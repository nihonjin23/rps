...
<p>
<a href="http://localhost:80/login.php">Please Log In</a>
</p>
<p>
Attempt to go to 
<a href="http://localhost:80/game.php">game.php</a> without logging in - it should fail with an error message.
<p>
